...
export const Editor = () => {
  ...
  return (
    <>
      <EditorContent className="max-w-[700px] mx-auto pt-16 prose prose-violet prose-invert" editor={editor} />
      {editor && (
        <FloatingMenu
          className="bg-zinc-700 shadow-xl border border-zinc-600 shadow-black/20 rounded-lg overflow-hidden flex flex-col divide-x divide-zinc-600"
          editor={editor}
          shouldShow={({ state }) => {

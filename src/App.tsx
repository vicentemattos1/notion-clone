...
function App() {
  return (
    <div className="min-h-screen p-8 text-zinc-50 bg-gradient-to-r from-green-200 via-green-300 to-blue-500">
      <div className="bg-zinc-800 w-[1100px] mx-auto rounded-xl min-h-[90vh] shadow-sm border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]">
